...
* [Service Workers Self](https://developer.mozilla.org/en-US/docs/Web/API/WorkerGlobalScope/self)

* [Service Workers Skip Waiting](https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorkerGlobalScope/skipWaiting)
