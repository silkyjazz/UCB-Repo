...
// NOTE: The subdocument schema must be defined before the parent document's schema.
...
employeeSchema.methods.getDocumentInfo = function (location) {
  // The 'this' keyword is used to specify the properties belonging to the particular instance
  console.log(
    `This Employee has the name, ${this.name}, and a salary of ${this.salary}`
  );
};
