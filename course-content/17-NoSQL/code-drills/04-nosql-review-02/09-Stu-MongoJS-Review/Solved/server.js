...
app.post("/submit", ({ body }, res) => {
  ...
  book.read = false;
  console.log(book);
  //Functionally, save and insert are very similar, 
  //especially if no _id value is passed. 
  //However, if an _id key is passed, save() will update the document,
  //while insert() will throw a duplicate key error.
