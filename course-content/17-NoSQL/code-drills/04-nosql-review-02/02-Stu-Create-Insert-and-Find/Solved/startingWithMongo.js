...
db.students.insert({name: 'Alvin', row:3, os:'Mac', hobbies:["Reading", "Surfing", "Dancing", 'Coding'] })

db.students.insert({name: 'Simon', row:1, os:'Mac', hobbies:['Coding', 'Music', 'Dogs', 'Working Out'] })

db.students.insert({name: 'Theodore', row:1, os:'Windows', hobbies:['Coding', 'Reading'] })

db.students.insert({name: 'Farley', row:3, os:'Mac', hobbies:['Coding', 'Hiking', 'MCU', 'Dabbing'] })
...
db.students.find({"$expr":{$gte:[{$size:"$hobbies"},4]}})

// 2. An entry for a single person.


db.students.find({name:'Theodore'})


db.students.find({$or:[{name:'Theodore'},{name:'Alvin'}]})
