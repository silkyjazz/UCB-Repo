...
* Must be backed by a MongoDB Database with Mongoose ORM (Sequelize ORM - with Instructor Approval)   

* Must have CRUD routes for creating, reading, updating, and deleting data
...
* Optional - Incorporate GraphQL into your application 
